            ...
            +"<section>"
                +"<h4>"
                    +"<ul style='text-align:center;'>"
                        +"<li>"
                            +"To see all products: "
                            +"<a href='http://snf-16318.ok-kno.grnetcloud.net:8080/servlets-db-demo/all-products'><u>All products</u></a>"
                        +"</li>"
                        +"<br>"
                        +"<li>"
                            +"To add a new product: "
                            +"<a href='http://snf-16318.ok-kno.grnetcloud.net:8080/servlets-db-demo/add-product.html'><u>Add product</u></a>"
                        +"</li>"
                    +"</ul>"
                +"</h4>"
            +"</section>"
